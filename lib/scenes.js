export const SCENES = {
  ...
  bus:      { name: 'Indian Bus Driver',  wire: '#c86b2a', fog: '#0a0605', amp: 0.10, speed: 0.20, density: 0.040 },
  alka:     { name: 'Alka Nostalgia',     wire: '#d4a64f', fog: '#0a0806', amp: 0.10, speed: 0.15, density: 0.035 },
};

export const SCENE_ORDER = ['river', 'ocean', 'forest', 'mountain', 'glacier', 'rain', 'bus', 'alka'];
