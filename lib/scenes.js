export const SCENES = {
  ...
  rain:     { name: 'Midnight Rain',       wire: '#4a6b8a', fog: '#050a14', amp: 0.15, speed: 0.90, density: 0.070 },
};

export const SCENE_ORDER = ['river', 'ocean', 'forest', 'valley', 'mountain', 'glacier', 'rain'];
